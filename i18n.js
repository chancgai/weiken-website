...
var textDict = [
  ...
  ['拥有三条万吨级生产线，可稳定生产宽度100mm-240mm、厚度24um-30um的铁基非晶带材。同时配备三条先进激光刻痕生产线，具备稳定生产鱼鳞纹带材和无纹带材的能力，年产能达30,000吨。与硅钢长达1000米以上的生产线相比，非晶带材一步成型产线仅约20米，制造能耗降低约70%，废料100%回收再熔炼，是真正的绿色制造。', 'Three 10,000-ton-class production lines producing 100-240mm wide, 24-30um thick ribbons; three advanced laser scoring lines for fish-scale and smooth surface ribbons; annual capacity of 30,000 tons.'],
  ...
  ['采用单辊平面流铸法（冷却速度约10⁶℃/s），合金熔体快速凝固而不发生结晶，形成短程有序、长程无序的非晶结构。提供WCAN-H、WCAN-HK、WCAN-Z三种牌号，带材宽度120mm~240mm，广泛应用于干式变压器铁芯、油浸式变压器铁芯、立体卷铁芯等领域。', 'Produced by single-roller planar flow casting with a cooling rate of approx. 10⁶ °C/s, the alloy solidifies without crystallization, forming a short-range ordered, long-range disordered amorphous structure. Available in WCAN-H, WCAN-HK, and WCAN-Z grades covering 120mm to 240mm widths for dry-type, oil-immersed, and 3D wound transformer cores.'],
  ...
  ['WCAN-Z多层复合带材采用5-8层非晶合金复合成型，最大宽度240mm。通过复合加工工艺，实现优异的高频损耗特性，专为高频电机和特种变压器应用设计。', 'WCAN-Z multi-layer composite ribbon uses 5-8 layers of amorphous alloy bonded together, with maximum width of 240mm. Through composite processing, it achieves excellent high-frequency loss characteristics, specifically designed for high-frequency motor and special transformer applications.'],
  ...
  ['全自动化产线覆盖分条、退火、卷绕、成型全流程。配备16台退火炉，35000平方米恒温厂房，年产能达20,000吨，叠片系数0.88。', 'Fully automated production line covering slitting, annealing, winding and forming. 16 annealing furnaces, 35,000sqm temperature-controlled factory, annual core capacity of 20,000 tons with stacking factor of 0.88.'],
  ...
  ["从非晶合金材料研发到电机铁芯量产，威恳非晶打造'研发-生产-复合-样品-量产'全链路，为客户提供从实验室到工厂的一站式非晶解决方案",
   "From amorphous alloy material R&D to motor core mass production, WCAN Amorphous builds a full-chain 'R&D-Production-Composite-Sample-Mass Production' pipeline, providing customers with one-stop amorphous solutions from lab to factory"],
  ...
  ["低空载损耗、高效节能，覆盖油浸式、干式、立体三大品类",
   "Ultra-low no-load loss, covering oil-immersed, dry-type and 3D wound cores"],
  ["铁损 P (50Hz, 1.35T) (W/kg)", "Core Loss P (50Hz, 1.35T) (W/kg)"],
  ["高频铁损低，适用于新能源汽车驱动电机及工业高效电机",
   "Low high-frequency loss, ideal for NEV drive motors and industrial motors"],
  ["致力于成为全球先进的铁基非晶合金材料研发制造企业",
   "Committed to becoming a globally advanced iron-based amorphous alloy material R&D and manufacturing enterprise"],
  ...
  ["采用快速凝固工艺，高磁导率、低铁损的新型软磁材料",
   "Rapid solidification process, high permeability and low core loss new soft magnetic material"],
  ...
  ['独特的无序原子结构造就卓越电磁性能', 'Unique disordered atomic structure delivers exceptional electromagnetic performance'],
  ['废料100%回收再熔炼，绿色制造', '100% recyclable, true green manufacturing'],
  ['多道工序：冶炼、热轧、冷轧、退火', 'Multi-step process: smelting, hot rolling, cold rolling, annealing'],
  ["52项专利（含13项发明专利）", "52 Patents (including 13 invention patents)"],
  ['一步快速凝固成型，产线约20米', 'Single-step rapid quenching, production line ~20 meters'],
  ...
  ['短程有序、长程无序的非晶结构', 'Short-range ordered, long-range disordered amorphous structure'],
  ['取向晶粒结构，存在磁各向异性', 'Grain-oriented structure with magnetic anisotropy'],
  ...
  ['制造能耗较硅钢降低约70%', '70% lower manufacturing energy vs silicon steel'],
  ...
  ['冷却速度高达10⁶℃/s', 'Cooling rate up to 10⁶°C/s'],
  ['生产线长达1000米以上', 'Production line over 1000 meters'],
  ...
  ['长程有序的晶态结构', 'Long-range ordered crystalline structure'],
  ['非晶合金·卓越之选', 'Amorphous Alloy: The Superior Choice'],
  ...
  ["铁基非晶合金带材", "Amorphous Alloy Ribbon"],
  ...
  ["威恳非晶亮相2026 CWIEME上海国际线圈展",
   "WCAN Amorphous Showcases at 2026 CWIEME Shanghai"],
  ["2026年6月24日至26日，亚太地区线圈、电机及变压器行业标杆盛会——2026 CWIEME上海国际线圈展在上海世博展览馆圆满举办。在这场汇聚全球超330家优质展商、吸引逾3万名国际专业观众的行业盛会上，威恳非晶与威恳科技联合亮相【展位1M01】，全面展示了从上游非晶合金材料研发到下游非晶电机铁心量产的完整产业链闭环。",
   "From June 24 to 26, 2026, the CWIEME Shanghai exhibition, a benchmark event for the coil, motor, and transformer industry in the Asia-Pacific region, was successfully held at the Shanghai World Expo Exhibition Center. At this industry gathering of over 330 quality exhibitors and more than 30,000 international professional visitors, WCAN Amorphous and WCAN Technology jointly appeared at [Booth 1M01], comprehensively showcasing the complete industry chain from upstream amorphous alloy material R&D to downstream amorphous motor core mass production."],
  ['威恳通过"威恳非晶"与"威恳科技"的专业化分工与全链路工艺协同，为客户构建了五大核心价值壁垒：材料配方与铁心工艺同步迭代实现快速响应；从合金熔炼到铁心成品全流程自主可控保障稳定交付；开发电机专用非晶合金材料配合先进铁心工艺确保卓越性能；核心技术在集团内部闭环流转保障信息安全；缩短供应链持续降低综合成本。',
   'Through the specialized division of labor and full-chain process collaboration between WCAN Amorphous and WCAN Technology, WCAN has built five core value barriers for customers: synchronized material formula and core process iteration for rapid response; full-process in-house control from alloy melting to core finishing for stable delivery; development of motor-specific amorphous alloy materials with advanced core processes for superior performance; closed-loop technology transfer within the group for information security; shortened supply chain for continuously reduced overall costs.'],
  ["在上游材料端，威恳非晶深耕铁基非晶带材研发制造十五年，拥有三条万吨级生产线，定向开发电机专用非晶带材，从源头确立产品一致性与稳定性。在下游应用端，威恳科技依托二十年高端电机铁心生产经验，配置顶级设备与非晶专用模具，成功实现非晶电机铁心的商业化量产。",
   "In the upstream material sector, WCAN Amorphous has been deeply engaged in Fe-based amorphous ribbon R&D and manufacturing for 15 years, with three 10,000-ton-class production lines, developing motor-specific amorphous ribbons to ensure product consistency and stability from the source. In the downstream application sector, WCAN Technology leverages 20 years of high-end motor core production experience, equipped with top-tier equipment and amorphous-specific tooling, successfully achieving commercial mass production of amorphous motor cores."],
  ['此次参展，威恳以"材料+制造"垂直一体化解决方案，向全球客户展现了在非晶电机领域的技术实力与产业布局，为新能源汽车、低空经济、人形机器人等新兴赛道提供高效、稳定、安全的供应链支撑。',
   'At this exhibition, WCAN presented its \'Material + Manufacturing\' vertically integrated solution to global customers, demonstrating its technical strength and industrial layout in the amorphous motor field, providing efficient, stable, and safe supply chain support for emerging sectors such as new energy vehicles, low-altitude economy, and humanoid robots.'],
  ["返回新闻列表",
   "Back to News List"],
  ["威恳非晶CWIEME展会现场",
   "WCAN Amorphous CWIEME Exhibition Scene"],
  ["威恳非晶展位",
   "WCAN Amorphous Booth"],
  ["展会产品展示",
   "Exhibition Product Display"],
  ["展会技术交流",
   "Exhibition Technical Exchange"],
  ["威恳非晶团队合影",
   "WCAN Amorphous Team Photo"],
  ['2026年6月24日至26日，威恳非晶与威恳科技联合亮相2026 CWIEME上海国际线圈展【展位1M01】，全面展示了从上游非晶合金材料研发到下游非晶电机铁心量产的完整产业链闭环，以"材料+制造"垂直一体化解决方案向全球客户展现技术实力。',
   'From June 24 to 26, 2026, WCAN Amorphous and WCAN Technology jointly appeared at the 2026 CWIEME Shanghai International Coil Exhibition [Booth 1M01], comprehensively showcasing the complete industry chain from upstream amorphous alloy material R&D to downstream amorphous motor core mass production, presenting technical strength to global customers with a \'Material + Manufacturing\' vertically integrated solution.'],
  ["了解威恳非晶最新动态、行业资讯与技术创新",
   "Latest updates, industry news, and technological innovations from WCAN"],
  ["物理性能 Property",
   "Physical Properties"],
  ["密度 Density (g/cm3)",
   "Density (g/cm3)"],
  ["晶化温度 Crystallization Temp (C)",
   "Crystallization Temp (C)"],
  ["抗拉强度 Tensile Strength (GPa)",
   "Tensile Strength (GPa)"],
  ["杨氏模量 Young Modulus (GPa)",
   "Young Modulus (GPa)"],
  ["维氏硬度 Vickers Hardness (Hv)",
   "Vickers Hardness (Hv)"],
  ["热膨胀系数 Thermal Expansion (x10-6/C)",
   "Thermal Expansion (x10-6/C)"],
  ["性能参数 Property",
   "Performance Parameters"],
  ["磁致伸缩系数 (×10⁻⁶)",
   "Magnetostriction Coefficient (×10⁻⁶)"],
  ["比总损耗 P(50Hz,1.35T) (W/kg)",
   "Specific Total Loss P(50Hz,1.35T) (W/kg)"],
  ["比总损耗 P(400Hz,1.0T) (W/kg)",
   "Specific Total Loss P(400Hz,1.0T) (W/kg)"],
  ["比总损耗 P(1000Hz,1.0T) (W/kg)",
   "Specific Total Loss P(1000Hz,1.0T) (W/kg)"],
  ["复合层数",
   "Composite Layers"],
  ["最大宽度 (mm)",
   "Max Width (mm)"],
  ["120~240（可定制）",
   "120~240 (Customizable)"],
  ["产品图片",
   "Product Image"],
  ["容量 (kVA)",
   "Capacity (kVA)"],
  ...
  ["国标15型 (W)",
   "GB-15 Standard (W)"],
  ["铁芯窗高 Core Window Height",
   "Core Window Height"],
  ["铁芯窗宽 Core Window Width",
   "Core Window Width"],
  ["铁芯最大外形尺寸 Max Outline",
   "Max Outline Dimensions"],
  ["铁芯叠厚 Stack Thickness",
   "Stack Thickness"],
  ["窗口内角半径 Inner Corner Radius",
   "Inner Corner Radius"],
  ["叠片系数 Stacking Factor",
   "Stacking Factor"],
  ["重量公差 Weight Tolerance",
   "Weight Tolerance"],
  ["搭接方式 Lap Joint Method",
   "Lap Joint Method"],
  ["分布式和固定式",
   "Distributed and Fixed Type"],
  ["单框铁芯参数",
   "Single-Frame Core Parameters"],
  ["符号",
   "Symbol"],
  ["范围 (mm)",
   "Range (mm)"],
  ...
  ["高度",
   "Height"],
  ["25年生命周期节电 (kWh)",
   "25-Year Lifecycle Energy Saving (kWh)"],
  ["CO₂减排 (吨)",
   "CO₂ Reduction (tons)"],
  ["空载损耗降低",
  ...
  ["参数 Parameter",
   "Parameters"],
  ["单只铁芯重量 Weight (kg)",
   "Single Core Weight (kg)"],
  ["三相铁芯总重 Total (kg)",
   "Three-Phase Total Weight (kg)"],
  ["噪音水平 Noise dB(A)",
   "Noise Level dB(A)"],
  ["短路阻抗 Short-circuit Z",
   "Short-circuit Impedance"],
  ["心柱有效截面 Cross-section (cm2)",
  ...
  ["退火炉（台）",
   "Annealing Furnaces"],
  ["恒温厂房（㎡）",
   "Temperature-controlled Factory (sqm)"],
  ["外形宽度",
   "Outline Width"],
  ["外形高度",
   "Outline Height"],
  ...
  ["非晶铁芯 Amorphous",
   "Amorphous Core"],
  ["AIDA、MINSTER、DOBBY、NIDEC（35,000㎡恒温车间）",
   "AIDA, MINSTER, DOBBY, NIDEC (35,000sqm temperature-controlled workshop)"],
  ["≤2.5 W/kg（硅钢 &gt;20 W/kg）",
   "≤2.5 W/kg (silicon steel >20 W/kg)"],
  ["三星、LG、现代、起亚",
   "Samsung, LG, Hyundai, Kia"],
  ["沪光、博格华纳、中车",
   "Huguang, BorgWarner, CRRC"],
  ["扬电科技、高晶股份、特变电工、置信电气、KEPCO",
   "Yangdian Tech, Gaojing Shares, TBEA, Zhixin Electric, KEPCO"],
  ["ISO认证",
   "ISO Certification"],
  ["3体系",
   "3 Systems"],
  ...
  ["专利总数（含13项发明）",
   "Total Patents (including 13 inventions)"],
  ["参与制定国标",
   "Participated in National Standards"],
  ["威恳非晶 - 关于我们 | 威恳非晶技术（浙江）有限公司",
   "WCAN Amorphous - About Us | WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["传承15年技术积淀，专注先进非晶合金材料制造",
   "Inheriting 15 years of technical expertise, focusing on advanced amorphous alloy manufacturing"],
  ["构建全链整合平台",
   "Building a full-chain integration platform"],
  ["2025年",
   "2025"],
  ["15年",
   "15 years"],
  ...
  ["已授权专利",
   "Authorized Patents"],
  ["威恳非晶技术（浙江）有限公司 - 首页",
   "WCAN Amorphous Technology (Zhejiang) Co., Ltd. - Home"],
  ["非晶带材产能",
   "Amorphous Ribbon Capacity"],
  ["变压器铁芯产能",
   "Transformer Core Capacity"],
  ["吨/年",
   "tons/year"],
  ["主推",
   "Featured"],
  ...
  ["当前没有进行中的招标采购公告。如有供应商合作意向，请将公司资质材料发送至采购部邮箱，我们将在有新项目时优先联系合格供应商。",
   "There are currently no ongoing procurement announcements. If you are interested in supplier cooperation, please send your company qualification materials to the procurement department email, and we will prioritize contacting qualified suppliers when new projects arise."],
  ["全部产品",
   "All Products"],
  ["覆盖非晶合金材料及铁芯加工的全品类产品线，满足不同应用场景需求",
   "Full product line covering amorphous alloy materials and core processing, meeting diverse application needs"],
  ["高磁导率、低矫顽力、低铁损的高效节能软磁材料，提供WCAN-H、WCAN-HK、WCAN-Z三种牌号",
   "High permeability, low coercivity, low core loss energy-efficient soft magnetic material, available in WCAN-H, WCAN-HK, WCAN-Z grades"],
  ["产品中心 - 威恳非晶技术（浙江）有限公司",
   "Products - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["企业新闻 - 威恳非晶技术（浙江）有限公司",
   "News - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["联系我们 - 威恳非晶技术（浙江）有限公司",
   "Contact - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["招采信息 - 威恳非晶技术（浙江）有限公司",
   "Procurement - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["铁基非晶合金带材 - 威恳非晶技术（浙江）有限公司",
   "Amorphous Alloy Ribbon - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["油浸式变压器铁芯 - 威恳非晶技术（浙江）有限公司",
   "Oil-immersed Transformer Core - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["干式变压器铁芯 - 威恳非晶技术（浙江）有限公司",
   "Dry-Type Transformer Core - WCAN Amorphous Technology (Zhejiang) Co., Ltd."],
  ["立体变压器铁芯 - 威恳非晶技术（浙江）有限公司",
